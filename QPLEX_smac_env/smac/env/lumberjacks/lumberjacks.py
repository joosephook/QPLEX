...
class Lumberjacks(gym.Env):
    ...
    def __init__(self, grid_shape: Coordinates = (5, 5), n_agents: int = 2, n_trees: int = 12,
                 ...
                 step_cost: float = -1, tree_cutdown_reward: float = 10, max_steps: int = 100, **kwargs):
...
def WrappedLumberjacks(*args, **kwargs):
    return MultiAgentWrapper(Lumberjacks(*args, **kwargs))
