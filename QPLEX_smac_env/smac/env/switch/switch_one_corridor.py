...
class Switch(gym.Env):
    ...
    def __init__(self, full_observable=False, step_cost=0, n_agents=4, max_steps=50, **kwargs):
...
def WrappedSwitch(*args, **kwargs):
    return MultiAgentWrapper(Switch(*args, **kwargs))
