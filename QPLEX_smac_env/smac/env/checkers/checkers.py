...
class Checkers(gym.Env):
    ...
    def __init__(self, full_observable=False, step_cost=-0.01, max_steps=100, **kwargs):
    ...
    def step(self, agents_action):
        ...
        return self.get_agent_obs(), rewards, self._agent_dones, dict(**self._food_count)
...
def WrappedCheckers(*args, **kwargs):
    return MultiAgentWrapper(Checkers(*args, **kwargs))