...
class TrafficJunction(gym.Env):
    ...
    def __init__(self, grid_shape=(14, 14), n_agents=10, n_max=10, arrive_prob=0.5, full_observable=False, **kwargs):
...
def WrappedTrafficJunction(*args, **kwargs):
    return MultiAgentWrapper(TrafficJunction(*args, **kwargs))
